...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#58e1cf' : 'black',

  concreteGray: darkMode ? '#292C2F' : '#FAFAFA',
  inputBackground: darkMode ? '#1F1F1F' : '#FAFAFA',
  shadowColor: darkMode ? '#000' : '#58e1cf',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#58e1cf',
  primary2: darkMode ? '#3680E7' : '#58e1cf',
  primary3: darkMode ? '#4D8FEA' : '#58e1cf',
  primary4: darkMode ? '#376bad70' : '#F6DDE8',
  primary5: darkMode ? '#153d6f70' : '#FDEAF1',

  // color text
  primaryText1: darkMode ? '#6da8ff' : '#58e1cf',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#58e1cf',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #58e1cf30 0%, #fff 0%)`,
})
